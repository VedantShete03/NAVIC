...
System::Void SDR::start(System::Object^ obj)
{
    ...
    //NAVIC
    //to edit
    /* channel setting */ /* NAVIC */
    setsdrini(form->chk_N1->Checked,1,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N2->Checked,2,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N3->Checked,3,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N4->Checked,4,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N5->Checked,5,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N6->Checked,6,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);
    setsdrini(form->chk_N7->Checked,7,SYS_NAV,form->rb_N_FE2->Checked,form->chk_TYPE_N1B->Checked,false,false,&sdrini);//end
